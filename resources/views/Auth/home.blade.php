          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="dist/img/user_man_1.png" class="user-image" alt="User Image">
                  <span class="hidden-xs">NameUser</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="dist/img/user_man_1.png" class="img-circle" alt="User Image">
                    <p>
                     NameUser
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="dist/img/user_man_1.png" class="img" alt="User Image">
            </div>
